<h1><a href="https://www.acmicpc.net/problem/2605">✔️2605번: 줄 세우기 BRONZEⅡ</a></h1>
...
### 2. 접근
```
1. 순서대로 줄을 서고, 뽑은 숫자만큼 움직여야하니 List를 사용하면 되겠다.

2. 뽑은 숫자 만큼 움직여야 하기 때문에 list메서드 중 list.add(index, value) 를 사용한다.
```

### 3. 풀이
```
1. 총 인원수를 입력받고, 본인 자리에서 뽑은 숫자 만큼 이동해야 하므로 list.add(i-k, i+1)을 해준다.
```
## 4. 코드
```
